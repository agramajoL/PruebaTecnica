...
VALUES('AE5BZ9', 'ALAN BARTOLOMEO DE LAS PUERTAS IXPUC', 'BLAH BLAH', 'Masculino', 12344321, TO_DATE('30/12/2022', 'DD/MM/YYYY'), TO_DATE('30/12/2022', 'DD/MM/YYYY'),TO_DATE('30/12/2022', 'DD/MM/YYYY'), 'Epico', 'Sistemas');
